...
const SearchBar: React.FC<SearchBarProps> = ({ query, setQuery, handleSearch }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:justify-between sm:gap-4 items-center mt-4 mb-[80px]">
      <h1 onClick={goBack} className="text-4xl cursor-pointer sm:text-6xl font-bold bg-gradient-to-r from-[#006AFF] to-[#00F9FF] text-transparent bg-clip-text  text-center sm:text-left">
        SkyConnect Explorer
      </h1>
